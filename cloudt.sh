...
<<<<<<< HEAD
		if ! wget --no-check-certificate "https://raw.githubusercontent.com/chenxinetwork/files/master/service/cloudt_centos" -O /etc/init.d/cloudt; then
=======
		if ! wget --no-check-certificate "https://gitee.com/chenxinetwork/files/raw/master/service/cloudt_centos" -O /etc/init.d/cloudt; then
...
<<<<<<< HEAD
		if ! wget --no-check-certificate "https://raw.githubusercontent.com/chenxinetwork/files/master/service/cloudt_debian" -O /etc/init.d/cloudt; then
=======
		if ! wget --no-check-certificate "https://gitee.com/chenxinetwork/files/raw/master/service/cloudt_debian" -O /etc/init.d/cloudt; then
>>>>>>> bb00a41f14ec232f9fd62519187bc465f3bb5c07
			echo -e "${Error} Cloud Torrent服务 管理脚本下载失败 !" && exit 1
		fi
		chmod +x /etc/init.d/cloudt
...
Update_Shell(){
<<<<<<< HEAD
	sh_new_ver=$(wget --no-check-certificate -qO- -t1 -T3 "https://raw.githubusercontent.com/chenxinetwork/files/master/cloudt.sh"|grep 'sh_ver="'|awk -F "=" '{print $NF}'|sed 's/\"//g'|head -1) && sh_new_type="github"
=======
	sh_new_ver=$(wget --no-check-certificate -qO- -t1 -T3 "https://gitee.com/chenxinetwork/files/raw/master/cloudt.sh"|grep 'sh_ver="'|awk -F "=" '{print $NF}'|sed 's/\"//g'|head -1) && sh_new_type="github"
>>>>>>> bb00a41f14ec232f9fd62519187bc465f3bb5c07
...
<<<<<<< HEAD
	wget -N --no-check-certificate "https://raw.githubusercontent.com/chenxinetwork/files/master/cloudt.sh" && chmod +x cloudt.sh
=======
	wget -N --no-check-certificate "https://gitee.com/chenxinetwork/files/raw/master/cloudt.sh" && chmod +x cloudt.sh
>>>>>>> bb00a41f14ec232f9fd62519187bc465f3bb5c07
	echo -e "脚本已更新为最新版本[ ${sh_new_ver} ] !(注意：因为更新方式为直接覆盖当前运行的脚本，所以可能下面会提示一些报错，无视即可)" && exit 0
}
echo && echo -e "  Cloud Torrent 一键管理脚本 ${Red_font_prefix}[v${sh_ver}]${Font_color_suffix}
  ---- Chenxi | doub.io/wlzy-12/ ----
