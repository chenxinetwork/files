...
Service(){
	if [[ ${release} = "centos" ]]; then
<<<<<<< HEAD
		if ! wget --no-check-certificate "https://raw.githubusercontent.com/chenxinetwork/files/master/service/mtproxy_go_centos" -O /etc/init.d/mtproxy-go; then
=======
		if ! wget --no-check-certificate "https://gitee.com/chenxinetwork/files/raw/master/service/mtproxy_go_centos" -O /etc/init.d/mtproxy-go; then
...
<<<<<<< HEAD
		if ! wget --no-check-certificate "https://raw.githubusercontent.com/chenxinetwork/files/master/service/mtproxy_go_debian" -O /etc/init.d/mtproxy-go; then
=======
		if ! wget --no-check-certificate "https://gitee.com/chenxinetwork/files/raw/master/service/mtproxy_go_debian" -O /etc/init.d/mtproxy-go; then
>>>>>>> bb00a41f14ec232f9fd62519187bc465f3bb5c07
			echo -e "${Error} MTProxy服务 管理脚本下载失败 !"
			rm -rf "${file}"
			exit 1
...
Update_Shell(){
<<<<<<< HEAD
	sh_new_ver=$(wget --no-check-certificate -qO- -t1 -T3 "https://raw.githubusercontent.com/chenxinetwork/files/master/mtproxy_go.sh"|grep 'sh_ver="'|awk -F "=" '{print $NF}'|sed 's/\"//g'|head -1) && sh_new_type="github"
=======
	sh_new_ver=$(wget --no-check-certificate -qO- -t1 -T3 "https://gitee.com/chenxinetwork/files/raw/master/mtproxy_go.sh"|grep 'sh_ver="'|awk -F "=" '{print $NF}'|sed 's/\"//g'|head -1) && sh_new_type="github"
>>>>>>> bb00a41f14ec232f9fd62519187bc465f3bb5c07
...
<<<<<<< HEAD
	wget -N --no-check-certificate "https://raw.githubusercontent.com/chenxinetwork/files/master/mtproxy_go.sh" && chmod +x mtproxy_go.sh
=======
	wget -N --no-check-certificate "https://gitee.com/chenxinetwork/files/raw/master/mtproxy_go.sh" && chmod +x mtproxy_go.sh
>>>>>>> bb00a41f14ec232f9fd62519187bc465f3bb5c07
