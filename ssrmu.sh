...
BBR_installation_status(){
	if [[ ! -e ${BBR_file} ]]; then
		...
		cd "${file}"
<<<<<<< HEAD
		if ! wget -N --no-check-certificate https://raw.githubusercontent.com/chenxinetwork/files/master/bbr.sh; then
=======
		if ! wget -N --no-check-certificate https://gitee.com/chenxinetwork/files/raw/master/bbr.sh; then
...
Download_SSR(){
	cd "/usr/local"
	wget -N --no-check-certificate "https://github.com/ChenxiDAdoubiBackup/shadowsocksr/archive/manyuser.zip"
	#git config --global http.sslVerify false
	#env GIT_SSL_NO_VERIFY=true git clone -b manyuser https://github.com/ChenxiDAdoubiBackup/shadowsocksr.git
...
Service_SSR(){
	if [[ ${release} = "centos" ]]; then
<<<<<<< HEAD
		if ! wget --no-check-certificate https://raw.githubusercontent.com/chenxinetwork/files/master/service/ssrmu_centos -O /etc/init.d/ssrmu; then
=======
		if ! wget --no-check-certificate https://gitee.com/chenxinetwork/files/raw/master/service/ssrmu_centos -O /etc/init.d/ssrmu; then
>>>>>>> bb00a41f14ec232f9fd62519187bc465f3bb5c07
...
<<<<<<< HEAD
		if ! wget --no-check-certificate https://raw.githubusercontent.com/chenxinetwork/files/master/service/ssrmu_debian -O /etc/init.d/ssrmu; then
=======
		if ! wget --no-check-certificate https://gitee.com/chenxinetwork/files/raw/master/service/ssrmu_debian -O /etc/init.d/ssrmu; then
>>>>>>> bb00a41f14ec232f9fd62519187bc465f3bb5c07
			echo -e "${Error} ShadowsocksR服务 管理脚本下载失败 !" && exit 1
		fi
		chmod +x /etc/init.d/ssrmu
...
BanBTPTSPAM(){
<<<<<<< HEAD
	wget -N --no-check-certificate https://raw.githubusercontent.com/chenxinetwork/files/master/ban_iptables.sh && chmod +x ban_iptables.sh && bash ban_iptables.sh banall
=======
	wget -N --no-check-certificate https://gitee.com/chenxinetwork/files/raw/master/ban_iptables.sh && chmod +x ban_iptables.sh && bash ban_iptables.sh banall
>>>>>>> bb00a41f14ec232f9fd62519187bc465f3bb5c07
...
UnBanBTPTSPAM(){
<<<<<<< HEAD
	wget -N --no-check-certificate https://raw.githubusercontent.com/chenxinetwork/files/master/ban_iptables.sh && chmod +x ban_iptables.sh && bash ban_iptables.sh unbanall
=======
	wget -N --no-check-certificate https://gitee.com/chenxinetwork/files/raw/master/ban_iptables.sh && chmod +x ban_iptables.sh && bash ban_iptables.sh unbanall
>>>>>>> bb00a41f14ec232f9fd62519187bc465f3bb5c07
	rm -rf ban_iptables.sh
}
Set_config_connect_verbose_info(){
...
Update_Shell(){
<<<<<<< HEAD
	sh_new_ver=$(wget --no-check-certificate -qO- -t1 -T3 "https://raw.githubusercontent.com/chenxinetwork/files/master/ssrmu.sh"|grep 'sh_ver="'|awk -F "=" '{print $NF}'|sed 's/\"//g'|head -1) && sh_new_type="github"
=======
	sh_new_ver=$(wget --no-check-certificate -qO- -t1 -T3 "https://gitee.com/chenxinetwork/files/raw/master/ssrmu.sh"|grep 'sh_ver="'|awk -F "=" '{print $NF}'|sed 's/\"//g'|head -1) && sh_new_type="github"
>>>>>>> bb00a41f14ec232f9fd62519187bc465f3bb5c07
	...
	cd "${file}"
<<<<<<< HEAD
	wget -N --no-check-certificate "https://raw.githubusercontent.com/chenxinetwork/files/master/ssrmu.sh" && chmod +x ssrmu.sh
=======
	wget -N --no-check-certificate "https://gitee.com/chenxinetwork/files/raw/master/ssrmu.sh" && chmod +x ssrmu.sh
>>>>>>> bb00a41f14ec232f9fd62519187bc465f3bb5c07
