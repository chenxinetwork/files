...
Service(){
	if [[ ${release} = "centos" ]]; then
<<<<<<< HEAD
		if ! wget --no-check-certificate https://raw.githubusercontent.com/chenxinetwork/files/master/service/daze_centos -O /etc/init.d/daze; then
=======
		if ! wget --no-check-certificate https://gitee.com/chenxinetwork/files/raw/master/service/daze_centos -O /etc/init.d/daze; then
...
<<<<<<< HEAD
		if ! wget --no-check-certificate https://raw.githubusercontent.com/chenxinetwork/files/master/service/daze_debian -O /etc/init.d/daze; then
=======
		if ! wget --no-check-certificate https://gitee.com/chenxinetwork/files/raw/master/service/daze_debian -O /etc/init.d/daze; then
>>>>>>> bb00a41f14ec232f9fd62519187bc465f3bb5c07
			echo -e "${Error} DAZE 服务管理脚本下载失败 !" && rm -rf "${Folder}" && exit 1
		fi
		chmod +x /etc/init.d/daze
...
View_daze(){
	...
	echo -e "${link}"
	echo -e "${Tip} 链接仅适用于Windows系统的 DAZE Tools 客户端（dbrj-17/）。"
	echo && echo "————————————————"
}
urlsafe_base64(){
...
Update_Shell(){
<<<<<<< HEAD
	sh_new_ver=$(wget --no-check-certificate -qO- -t1 -T3 "https://raw.githubusercontent.com/chenxinetwork/files/master/daze.sh"|grep 'sh_ver="'|awk -F "=" '{print $NF}'|sed 's/\"//g'|head -1) && sh_new_type="github"
=======
	sh_new_ver=$(wget --no-check-certificate -qO- -t1 -T3 "https://gitee.com/chenxinetwork/files/raw/master/daze.sh"|grep 'sh_ver="'|awk -F "=" '{print $NF}'|sed 's/\"//g'|head -1) && sh_new_type="github"
>>>>>>> bb00a41f14ec232f9fd62519187bc465f3bb5c07
...
<<<<<<< HEAD
	wget -N --no-check-certificate "https://raw.githubusercontent.com/chenxinetwork/files/master/daze.sh" && chmod +x daze.sh
=======
	wget -N --no-check-certificate "https://gitee.com/chenxinetwork/files/raw/master/daze.sh" && chmod +x daze.sh
>>>>>>> bb00a41f14ec232f9fd62519187bc465f3bb5c07
