...
Download_ocserv(){
	...
	if [[ -e ${file} ]]; then
		mkdir "${conf_file}"
<<<<<<< HEAD
		wget --no-check-certificate -N -P "${conf_file}" "https://raw.githubusercontent.com/chenxinetwork/files/master/other/ocserv.conf"
=======
		wget --no-check-certificate -N -P "${conf_file}" "https://gitee.com/chenxinetwork/files/raw/master/other/ocserv.conf"
...
Service_ocserv(){
<<<<<<< HEAD
	if ! wget --no-check-certificate https://raw.githubusercontent.com/chenxinetwork/files/master/service/ocserv_debian -O /etc/init.d/ocserv; then
=======
	if ! wget --no-check-certificate https://gitee.com/chenxinetwork/files/raw/master/service/ocserv_debian -O /etc/init.d/ocserv; then
>>>>>>> bb00a41f14ec232f9fd62519187bc465f3bb5c07
...
<<<<<<< HEAD
			wget --no-check-certificate -O "/etc/apt/sources.list" "https://raw.githubusercontent.com/chenxinetwork/files/master/sources/us.sources.list"
=======
			wget --no-check-certificate -O "/etc/apt/sources.list" "https://gitee.com/chenxinetwork/files/raw/master/sources/us.sources.list"
>>>>>>> bb00a41f14ec232f9fd62519187bc465f3bb5c07
			apt-get update
			apt-get install vim net-tools pkg-config build-essential libgnutls28-dev libwrap0-dev liblz4-dev libseccomp-dev libreadline-dev libnl-nf-3-dev libev-dev gnutls-bin -y
...
Update_Shell(){
<<<<<<< HEAD
	sh_new_ver=$(wget --no-check-certificate -qO- -t1 -T3 "https://raw.githubusercontent.com/chenxinetwork/files/master/ocserv.sh"|grep 'sh_ver="'|awk -F "=" '{print $NF}'|sed 's/\"//g'|head -1) && sh_new_type="github"
=======
	sh_new_ver=$(wget --no-check-certificate -qO- -t1 -T3 "https://gitee.com/chenxinetwork/files/raw/master/ocserv.sh"|grep 'sh_ver="'|awk -F "=" '{print $NF}'|sed 's/\"//g'|head -1) && sh_new_type="github"
>>>>>>> bb00a41f14ec232f9fd62519187bc465f3bb5c07
...
<<<<<<< HEAD
	wget -N --no-check-certificate "https://raw.githubusercontent.com/chenxinetwork/files/master/ocserv.sh" && chmod +x ocserv.sh
=======
	wget -N --no-check-certificate "https://gitee.com/chenxinetwork/files/raw/master/ocserv.sh" && chmod +x ocserv.sh
>>>>>>> bb00a41f14ec232f9fd62519187bc465f3bb5c07
