...
Service_brook(){
	if [[ ${release} = "centos" ]]; then
<<<<<<< HEAD
		if ! wget --no-check-certificate "https://raw.githubusercontent.com/chenxinetwork/files/master/service/brook_centos" -O /etc/init.d/brook; then
=======
		if ! wget --no-check-certificate "https://gitee.com/chenxinetwork/files/raw/master/service/brook_centos" -O /etc/init.d/brook; then
...
<<<<<<< HEAD
		if ! wget --no-check-certificate "https://raw.githubusercontent.com/chenxinetwork/files/master/service/brook_debian" -O /etc/init.d/brook; then
=======
		if ! wget --no-check-certificate "https://gitee.com/chenxinetwork/files/raw/master/service/brook_debian" -O /etc/init.d/brook; then
>>>>>>> bb00a41f14ec232f9fd62519187bc465f3bb5c07
			echo -e "${Error} Brook服务 管理脚本下载失败 !" && rm -rf "${file}" && exit 1
		fi
		chmod +x "/etc/init.d/brook"
...
View_brook(){
	...
	echo
	echo -e "${Tip} Brook链接 仅适用于Windows系统的 Brook Tools客户端（dbrj-7/）。"
	echo
}
brook_link(){
...
Update_Shell(){
<<<<<<< HEAD
	sh_new_ver=$(wget --no-check-certificate -qO- -t1 -T3 "https://raw.githubusercontent.com/chenxinetwork/files/master/brook.sh"|grep 'sh_ver="'|awk -F "=" '{print $NF}'|sed 's/\"//g'|head -1) && sh_new_type="github"
=======
	sh_new_ver=$(wget --no-check-certificate -qO- -t1 -T3 "https://gitee.com/chenxinetwork/files/raw/master/brook.sh"|grep 'sh_ver="'|awk -F "=" '{print $NF}'|sed 's/\"//g'|head -1) && sh_new_type="github"
>>>>>>> bb00a41f14ec232f9fd62519187bc465f3bb5c07
...
<<<<<<< HEAD
	wget -N --no-check-certificate "https://raw.githubusercontent.com/chenxinetwork/files/master/brook.sh" && chmod +x brook.sh
=======
	wget -N --no-check-certificate "https://gitee.com/chenxinetwork/files/raw/master/brook.sh" && chmod +x brook.sh
>>>>>>> bb00a41f14ec232f9fd62519187bc465f3bb5c07
