...
Download_aria2(){
	mkdir "${file}" && cd "${file}"
<<<<<<< HEAD
	wget --no-check-certificate -N "https://raw.githubusercontent.com/chenxinetwork/files/master/other/Aria2/aria2.conf"
	[[ ! -s "aria2.conf" ]] && echo -e "${Error} Aria2 配置文件下载失败 !" && rm -rf "${file}" && exit 1
	wget --no-check-certificate -N "https://raw.githubusercontent.com/chenxinetwork/files/master/other/Aria2/dht.dat"
=======
	wget --no-check-certificate -N "https://gitee.com/chenxinetwork/files/raw/master/other/Aria2/aria2.conf"
	[[ ! -s "aria2.conf" ]] && echo -e "${Error} Aria2 配置文件下载失败 !" && rm -rf "${file}" && exit 1
	wget --no-check-certificate -N "https://gitee.com/chenxinetwork/files/raw/master/other/Aria2/dht.dat"
...
<<<<<<< HEAD
		if ! wget --no-check-certificate https://raw.githubusercontent.com/chenxinetwork/files/master/other/aria2_centos -O /etc/init.d/aria2; then
=======
		if ! wget --no-check-certificate https://gitee.com/chenxinetwork/files/raw/master/other/aria2_centos -O /etc/init.d/aria2; then
>>>>>>> bb00a41f14ec232f9fd62519187bc465f3bb5c07
...
<<<<<<< HEAD
		if ! wget --no-check-certificate https://raw.githubusercontent.com/chenxinetwork/files/master/other/aria2_debian -O /etc/init.d/aria2; then
=======
		if ! wget --no-check-certificate https://gitee.com/chenxinetwork/files/raw/master/other/aria2_debian -O /etc/init.d/aria2; then
>>>>>>> bb00a41f14ec232f9fd62519187bc465f3bb5c07
			echo -e "${Error} Aria2服务 管理脚本下载失败 !" && exit 1
		fi
		chmod +x /etc/init.d/aria2
...
<<<<<<< HEAD
		wget --no-check-certificate -O "/etc/apt/sources.list" "https://raw.githubusercontent.com/chenxinetwork/files/master/sources/us.sources_stretch.list"
=======
		wget --no-check-certificate -O "/etc/apt/sources.list" "https://gitee.com/chenxinetwork/files/raw/master/sources/us.sources_stretch.list"
>>>>>>> bb00a41f14ec232f9fd62519187bc465f3bb5c07
		apt-get update
...
<<<<<<< HEAD
	sh_new_ver=$(wget --no-check-certificate -qO- "https://raw.githubusercontent.com/chenxinetwork/files/master/aria2.sh"|grep 'sh_ver="'|awk -F "=" '{print $NF}'|sed 's/\"//g'|head -1)
=======
	sh_new_ver=$(wget --no-check-certificate -qO- "https://gitee.com/chenxinetwork/files/raw/master/aria2.sh"|grep 'sh_ver="'|awk -F "=" '{print $NF}'|sed 's/\"//g'|head -1)
>>>>>>> bb00a41f14ec232f9fd62519187bc465f3bb5c07
	...
	if [[ ${sh_new_ver} != ${sh_ver} ]]; then
		...
		if [[ ${yn} == [Yy] ]]; then
<<<<<<< HEAD
			wget -N --no-check-certificate https://raw.githubusercontent.com/chenxinetwork/files/master/aria2.sh && chmod +x aria2.sh
=======
			wget -N --no-check-certificate https://gitee.com/chenxinetwork/files/raw/master/aria2.sh && chmod +x aria2.sh
>>>>>>> bb00a41f14ec232f9fd62519187bc465f3bb5c07
